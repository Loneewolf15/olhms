<div class="about-wrap  " id="about">
  <div class="container">
    <div class="about_sec">
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="aboutImg"><img src="<?php echo URLROOT ?>/assets/images/aboutImg_1603683937.png" alt=""></div>
        </div>
        <div class="col-lg-5">
          <div class="about_box">
            <div class="title">
            ...
            <ul class="edu_list">
              <li>
                <div class="learing-wrp">
                  <div class="edu_icon"><img src="<?php echo URLROOT ?>/assets/images/education.png" alt=""></div>
              ...
              <li>
                <div class="learing-wrp">
                  <div class="edu_icon"><img src="<?php echo URLROOT ?>/assets/images/class.png" alt=""></div>
                  <div class="learn_info">
              ...
              <li>
                <div class="learing-wrp">
                  <div class="edu_icon"><img src="<?php echo URLROOT ?>/assets/images/academy.png" alt=""></div>
                  <div class="learn_info">
